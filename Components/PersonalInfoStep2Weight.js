...
export default function PersonalInfoStep2Weight({ navigation }) {
  ...
  useEffect(() => {
    // Устанавливаем начальный offset, чтобы «курсор» был на текущем значении
    const initialOffset =
  ...
  return (
    <ImageBackground
      source={require('../assets/bg.png')} // <-- Ваш фон
      style={styles.bgImage}
      resizeMode="cover"
    >
      {/* Основной контейнер (не закрашиваем фон, чтобы видеть изображение) */}
      <View style={styles.container}>
        ...
        {/* Контент с «линейкой» для выбора веса */}
            ...
            >
              {valuesArray.map((val, index) => {
                ...
                const inputRange = [
                  ...
                  index * TICK_SPACING,
                  (index + 1) * TICK_SPACING,
                ];// Анимации увеличения / прозрачности
